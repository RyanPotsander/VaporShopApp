 ...
 */
public abstract class BaseRecyclerFragment extends android.app.Fragment{
    ...
    public class ExtTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            ...
            if(view!=null && extClickListener!=null && gestureDetector.onTouchEvent(motionEvent)){
                extClickListener.onClick(view, recyclerView.getChildAdapterPosition(view), motionEvent);
            }
            return false;
        }
